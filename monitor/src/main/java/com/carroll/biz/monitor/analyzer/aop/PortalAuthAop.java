package com.carroll.biz.monitor.analyzer.aop;

import com.carroll.biz.monitor.analyzer.auth.UserTokenEntity;
...
public class PortalAuthAop {
     ...
     */
    @Pointcut("@within(org.springframework.web.bind.annotation.RestController) && execution(* com.carroll.biz.monitor.analyzer.controller..*.*(..))")
    ...
    private void beforeInterceptor(JoinPoint joinPoint) throws BaseException {
        // 接收到请求，记录请求内容
