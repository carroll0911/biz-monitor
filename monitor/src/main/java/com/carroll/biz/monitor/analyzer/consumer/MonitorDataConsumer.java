...
import com.carroll.biz.monitor.analyzer.config.ThreadPoolConfig;
...
/**
 * 监控数据处理
 * Created on 202017/11/22 13:18 By hehongbo
 * <p>
...
public class MonitorDataConsumer {
     ...
     * @param cr
     */
    @KafkaListener(topics = {KafkaTopic.MONITOR_DATA})
    @SuppressWarnings("unused")
     ...
     * @param cr
     */
    @KafkaListener(topics = {KafkaTopic.MONITOR_DATA}, containerFactory = "timeContainerFactory")
    @SuppressWarnings("unused")
    ...
    private void summary(MonitorItem monitorItem, MonitorDataEx dataEx, boolean resultFlag, boolean timeout) {
        ...
        Date date = OldDateUtils.dayBegin(new Date(dataEx.getTime()));
