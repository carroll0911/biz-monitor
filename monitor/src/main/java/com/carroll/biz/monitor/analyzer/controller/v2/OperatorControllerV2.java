...
import com.carroll.biz.monitor.analyzer.request.ModifySelfRequest;
...
public class OperatorControllerV2 extends BaseController {
    ...
    public LoginResponse login(@Valid LoginRequest request, BindingResult result) throws MonitorBaseException {
    ...
    public MonitorBaseResponse resetPwd(@Valid @RequestBody IdRequest request, BindingResult result) throws MonitorBaseException {
    ...
    public MonitorBaseResponse modifyPwd(@Valid @RequestBody ModifyPasswordReq request, BindingResult result) throws MonitorBaseException {
    ...
    public MonitorBaseResponse modifySelf(@Valid @RequestBody ModifySelfRequest request, BindingResult result) throws BaseException {
