...
import com.carroll.biz.monitor.analyzer.request.MonitorItemSaveRequest;
...
public class MonitorItemControllerV2 extends BaseController {
    ...
    public MonitorItemResponse save(@Valid @RequestBody MonitorItemSaveRequest request, BindingResult result) throws BaseException {
    ...
    public MonitorBaseResponse enable(@Valid @RequestBody IdRequest request) throws BaseException {
    ...
    public MonitorBaseResponse disable(@Valid @RequestBody IdRequest request) throws BaseException {
    ...
    public MonitorBaseResponse delete(@Valid @ModelAttribute IdRequest request) throws BaseException {
